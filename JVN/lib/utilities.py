CWD = f'/Users/Shared/SharedProjects/Projects/JVNprobes/JVN/'
...
def notebook2python(filename: str, notebook: str = '', script: str = 'lib/', markdown: str = 'markdown/') -> None:
	import pathlib
	...
	try:
		if pathlib.Path(notebook_path).is_file():
			...
			raise FileNotFoundError(f'File not found. Check "{notebook_path}" variable.')
